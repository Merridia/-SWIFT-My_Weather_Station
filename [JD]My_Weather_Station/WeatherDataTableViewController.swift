...
class WeatherDataTableViewController: UITableViewController {
    ...
    @IBOutlet weak var DataDetailsCell: UITableViewCell!
    
    @IBOutlet weak var buttonShowMoreData: UIBarButtonItem!
    ...
    override func viewDidLoad() {
        ...
        tabview.registerClass(UITableViewCell.self, forCellReuseIdentifier: "cell3")
